-- Ensure views system functions exist and work properly
-- This migration ensures the record_video_view function is available
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'videos' AND column_name = 'view_count' AND table_schema = 'public') THEN
        RAISE NOTICE 'Success: view_count column exists in videos table';
    ELSE
