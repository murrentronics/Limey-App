...
CREATE OR REPLACE POLICY "Users can view chats they are part of and haven't deleted" ON chats
  FOR SELECT USING (
...
CREATE OR REPLACE POLICY "Users can view messages in their chats that aren't deleted for everyone" ON messages
  FOR SELECT USING (
