-- Username Uniqueness Migration for Supabase (Clean Version)
...
-- Step 8: Verify the migration worked (clean output)
-- Check for any remaining duplicates (count only)
...
-- Check for any invalid usernames (count only)
