...
const Inbox = () => {
  ...
  // Show loading screen during auth loading or if admin (before redirect)
  if (authLoading || isAdmin) {
    return (
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* System Notification Fullscreen Modal */}
          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-white/10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white">System Notification</h2>
                  <p className="text-sm text-white/60">{formatTime(selectedAdminNotification.created_at)}</p>
                </div>
              </div>
              <Button
                variant="ghost"
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6">
              ...
              <div>
                ...
                <p className="text-white font-semibold text-lg">{selectedAdminNotification.title}</p>
              </div>
              ...
              {/* Sender Info */}
              <div>
                <label className="text-sm font-medium text-white/70 block mb-2">From</label>
                <div className="bg-black/40 border border-white/10 rounded-lg p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 text-sm">Official notification</p>
                    </div>
                  </div>
                </div>
              </div>
