...
const Message = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (chatSearchError) {
        console.error('Error searching for existing chat:', chatSearchError);
        throw chatSearchError;
      }
      ...
      toast({
        title: "Message sent",
        description: `Your message was sent to @${receiver.username}`,
      });
      
      // Navigate to the chat with a small delay to ensure the message is processed
      setTimeout(() => {
