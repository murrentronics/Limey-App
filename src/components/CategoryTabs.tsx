        ...
        <div className="flex items-center justify-between px-4 py-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button 
              ...
              className="text-green-500 border border-green-500/20 hover:bg-green-500/10"
            >
              Upload
            </Button>
        ...
        <div className="flex overflow-x-auto scrollbar-hide px-4 pb-2 mx-[10px] my-[50px]">
          {categories.map(category => 
            <Button 
              ...
              size="sm" 
              className={`flex-shrink-0 mr-2 ${selectedCategory === category ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground"}`} 
